...
class TableTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testRenderProvider()
    {
        $books = array(
            ...
            array('9971-5-0210-0', 'A Tale of Two Ramen', 'Charles Dickens'),
...
| 9971-5-0210-0 | A Tale of Two Ramen     | Charles Dickens  |
...
TABLE
            ...
            'Cell text with tags used for Output styling' => array(
                ...
                array(
                    ...
                    array('9971-5-0210-0', 'A Tale of Two Ramen', '<info>Charles Dickens</>'),
                ),
                'default',
<<<TABLE
+---------------+----------------------+-----------------+
